                ...
                <div class="row">
                    <div class="col-md-12 ftco-animate">
                        <div class="single-slider owl-carousel">
                            <div class="item">
                                <div class="hotel-img" style="background-image: url(../web/images/{{ $product->image }});"></div>
                            </div>
                            {{-- <div class="item">
                                <div class="hotel-img" style="background-image: url(../web/images/hotel-3.jpg);"></div>
                            </div>
                            <div class="item">
                                <div class="hotel-img" style="background-image: url(../web/images/hotel-4.jpg);"></div>
                            </div> --}}
                        </div>
                    </div>
                    <div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
                        ...
                        <h2> {{ $product->title }}</h2>
                        <p class="rate mb-5">
                            <span class="loc"><a href="#"><i class="icon-map">{{ $product->city }}</i> </a></span>
                            <span class="star">
                                <i class="icon-star"></i>
                                <i class="icon-star"></i>
                                <i class="icon-star"></i>

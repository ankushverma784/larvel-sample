    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 ftco-animate">
          ...
          <p>
            <img src="../web/images/image_7.jpg" alt="" class="img-fluid">
          </p>
          ...
          <p>
            <img src="../web/images/image_8.jpg" alt="" class="img-fluid">
          </p>
          ...
          <div class="about-author d-flex p-5 bg-light">
            <div class="bio align-self-md-center mr-5">
              <img src="../web/images/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4">
            </div>
